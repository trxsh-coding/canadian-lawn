...
import { LawnProductDetail } from '@/components/sections/Product';
...
export default async function LawnMixDetailPage({ params }: { params: Promise<{ slug: string }> }) {
